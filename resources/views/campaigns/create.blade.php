				...
				<form method="POST" action="{{ url('create/campaign') }}" enctype="multipart/form-data" id="formUpload">
					...
					<div class="filer-input-dragDrop position-relative" id="draggable">
						...
						<div class="filer-input-inner">
							...
							<div class="filer-input-text">
								...
								<h3>{{ trans('misc.max_size') }}:
									{{App\Helper::formatBytes($settings->file_size_allowed * 1024) .' - '.$settings->min_width_height_image}}
								</h3>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<input type="text" value="{{ old('title') }}" name="title" id="title" class="form-control"
							placeholder="{{ trans('misc.campaign_title') }}">
					</div><!-- /.form-group-->
					...
					<div class="form-group">
						...
						<input type="text" value="{{ old('location') }}" name="location" class="form-control"
							placeholder="{{ trans('misc.location') }}">
					</div><!-- /.form-group-->
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text" value="{{ old('deadline') }}" id="datepicker" name="deadline"
								class="form-control" placeholder="{{ trans('misc.deadline') }}">
						</div>
					...
					<div class="form-group">
						...
						<textarea name="description" rows="4" id="description" class="form-control tinymce-txt"
							placeholder="{{ trans('misc.campaign_description_placeholder') }}">{{ old('description') }}</textarea>
					</div>
					...
					<div class="box-footer">
						<hr />
						<button type="submit" id="buttonFormSubmit"
							class="btn btn-block btn-lg btn-main custom-rounded">{{ trans('misc.create_campaign') }}</button>
					</div><!-- /.box-footer -->
				</form>
