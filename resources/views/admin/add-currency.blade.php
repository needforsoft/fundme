            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="box box-danger">
                        ...
                        <!-- form start -->
                        <form class="form-horizontal" method="POST" action="{{ url('panel/admin/currencies/add')}}"
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" value="{{ old('currency_code')}} name=" currency_code"
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">{{ trans('auth.curreny_symbol') }}</label>
                                    <div class="col-sm-10">
                                        <input type="text" value="{{ old('currency_symbol') }}" name="currency_symbol"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="role" class="form-control">
                                            <option @if(old('currency_symbol_position')=='right' ) selected="selected"
                                                @endif value="right">{{trans('admin.right')}}</option>
                                            <option @if(old('currency_symbol_position')=='left' ) selected="selected"
