...
class AdminController extends Controller
{
	...
	public function paymentsGateways($id)
	{
		...
		return view('admin.' . Str::slug($name) . '-settings')->withData($data);
	} //<--- End Method
	...
	public function editCurrency($currency_code)
	{
		$data = Currency::findOrFail($currency_code);
		return 	view('admin.edit-currency')->withData($data);
	}

	public function updateCurrency($currency_code, Request $request)
	{
	...
	{
		$data = Currency::orderBy('currency_code', 'DESC')->get();
		return view("admin.currencies")->withData($data);
	}
